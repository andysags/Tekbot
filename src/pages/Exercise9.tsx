        ...
        <div>
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between text-sm text-gray-500">
              <span>Progression</span>
               <span className="inline-block text-xs bg-violet-50 text-violet-400 px-2 py-0.5 rounded">Étape 5/5</span>
            </div>
          ...
          <div className="mt-16 flex justify-center">
            <div className="w-full max-w-xl bg-white rounded-xl p-8 shadow-sm border border-gray-100 text-center">
              ...
              <h2 className="text-xl font-bold text-[#25346f] mt-4">Félicitations !</h2>
              <p className="text-sm text-emerald-600 mt-2">Félicitations — exercice validé.</p>
              ...
              <div className="mt-6">
                <Link to="/courses" className="inline-block bg-emerald-500 text-white px-6 py-2 rounded-full font-medium shadow">Étape suivante</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="sticky top-20 space-y-6">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="mt-4 space-y-3">
               ...
               <div className="rounded-lg bg-emerald-50 border border-emerald-200 p-3 flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center text-xs">✓</div>
                  <div className="text-sm text-emerald-700">Testez sur différentes tailles d'écran</div>
                </div>

                <div className="rounded-lg bg-violet-50 border border-violet-100 p-3 flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-violet-200 text-violet-700 flex items-center justify-center text-xs">5</div>
                  <div className="text-sm text-violet-700">Optimisez l'accessibilité</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="text-sm text-gray-600 mt-2">Points totaux <span className="text-amber-500 font-semibold"> 50</span></div>
